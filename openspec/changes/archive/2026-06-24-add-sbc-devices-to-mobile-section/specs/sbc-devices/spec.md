...
### Requirement: Top 10 SBC - Overall Chart
The system SHALL identify SBC devices in the dataset and render a horizontal bar chart displaying the top 10 highest individual Main Scores recorded by SBC devices. When a user hovers over a data point, the tooltip SHALL display the client-id (first 8 characters) of that run.

#### Scenario: Rendering the Top 10 SBC - Overall chart
- **WHEN** the dashboard page finishes loading the benchmark data
